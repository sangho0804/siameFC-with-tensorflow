...
x_train, x_test = train_test_split(x_images, test_size=0.2, random_state=0)
z_train, z_test = train_test_split(z_images, test_size=0.2, random_state=0)
label_train, label_test = train_test_split(label, test_size=0.2, random_state=0)
